...
os.environ["groq_track"]=os.getenv("groq_track")
...
user_urls = input("Enter URLs separated by commas: ")
...
#print(web_search_tool.input_schema.model_json_schema())
...
def give_up(state):
    ...
    return {"generation": "Sorry, I couldn't find any relevant information. Please try rephrasing your question."}
